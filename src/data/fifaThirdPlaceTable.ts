// Tableau FIFA officiel — Annexe « Combinations for eight best third-placed teams »
// Extrait de FWC26_regulations_EN.pdf (pages 80-97).
//
// Clé : les 8 lettres des groupes qualifiés (parmi les meilleurs 3es), triées
//       par ordre alphabétique (ex. "ABCDEFGH").
// Valeur : pour chacun des 8 slots du R32 qui attendent un 3e (1A, 1B, 1D, 1E,
//          1G, 1I, 1K, 1L), la lettre du groupe d'origine du 3e qui s'y place.
//
// C(12,8) = 495 combinaisons, toutes présentes dans le tableau officiel.

export type SlotKey = '1A' | '1B' | '1D' | '1E' | '1G' | '1I' | '1K' | '1L';

export const FIFA_THIRD_PLACE_SLOTS: readonly SlotKey[] = ['1A', '1B', '1D', '1E', '1G', '1I', '1K', '1L'] as const;

// Mapping nom du match dans le bracket → slot du tableau FIFA
// (basé sur les seeds officiels du bracket dans data/bracket.ts)
...
export const FIFA_THIRD_PLACE_TABLE: Record<string, Record<SlotKey, string>> = {
